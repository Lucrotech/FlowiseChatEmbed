    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          width: bubbleProps.theme?.chatWindow?.width ? `${bubbleProps.theme?.chatWindow?.width.toString()}px` : 'calc(100%)',
        ...
        class={
          `fixed sm:right-5 rounded-lg w-[400px] sm:w-[400px] max-h-[704px]` +
